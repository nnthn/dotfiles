...
(custom-set-variables
 ...
 '(package-selected-packages
   '(web-completion-data magit expand-region corfu marginalia embark orderless vertico ligature mood-line smooth-scrolling wildcharm-theme leaf-keywords)))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:font "JetBrains Mono" :height 120))) nil "Customized with leaf in `emacs' block at `/home/nnthn/.emacs.el'")
 '(fixed-pitch ((t (:font "JetBrains Mono" :height 120))) nil "Customized with leaf in `emacs' block at `/home/nnthn/.emacs.el'")
 '(variable-pitch ((t (:font "Atkinson Hyperlegible" :height 140))) nil "Customized with leaf in `emacs' block at `/home/nnthn/.emacs.el'"))
